...
<style>
   ...
   <img src="../img/airtz.png" alt="Avatar" class="avatar" style="padding-left:325px">
...
<h2 style="text-align:center; font-size:14px;">Acredited by Tanzania Civil Aviation Authority (TCAA)</h2></h3>
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-10 col-md-9 col-11 text-center" style="background-color: rgb(0,0,0,0.2);color:white;border-radius:50px">

<div class="card-body"  >
<div class="card-header" style="background-color:#65b3d6; font-size:14px;border-radius:50px"> <strong> PERSONAL DETAILS</strong></div>
